...
HEADING = "heading"
EXCEL_FORMAT_STR = "excel_format_str"
known_keys = [DISPLAY_LENGTH, HEADING, EXCEL_FORMAT_STR, NAME]

# TODO merge with field_metadata FieldMetadata pdsutil.DbUtil.DatabaseColumn


class DatasetColumnMeta:
    def __init__(self, **kwargs):
        ...
        logger.debug("instantiating %s" % kwargs)
        ...
        if DISPLAY_LENGTH in kwargs:
            ...
            self.width = None
        if EXCEL_FORMAT_STR in kwargs:
            self.format_str = kwargs[EXCEL_FORMAT_STR]
        else:
...
class DatasetColumnsMeta:
    ...
    def add_column_dict(self, column_meta_dict): # TODO document type
        """
        :param column_meta: WorksheetColumnMeta
        :return: None
        """
        ...
        column_meta = DatasetColumnMeta(**column_meta_dict)
